...
struct MhRobotConfigData{
    public:
        inline std::vector<double> get_pulseEquivalent(){return pulseEquivalent;};
        inline double get_averagePulseEquivalent(){return averagePulseEquivalent;};
        inline std::vector<double> get_offset2(){return offset2;};
        inline std::vector<double> get_direction(){return direction;};
        inline std::vector<double> get_ratio(){return ratio;};
    protected:
